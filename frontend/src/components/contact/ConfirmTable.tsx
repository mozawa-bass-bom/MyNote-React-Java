      ...
      <table className="w-full max-w-2xl text-sm border rounded overflow-hidden">
        <tbody>
          <tr className="border-b">
            <th className="bg-muted w-32 p-2 text-left font-medium">お名前</th>
            <td className="p-2">{name}</td>
          </tr>
          <tr className="border-b">
            <th className="bg-muted w-32 p-2 text-left font-medium">メール</th>
            <td className="p-2">{email}</td>
          </tr>
          <tr>
            <th className="bg-muted w-32 p-2 text-left align-top font-medium">内容</th>
