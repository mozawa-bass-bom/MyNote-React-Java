...
public class AuthService {
     ...
     */
	 @Transactional(readOnly = true)
	    public boolean isUserNameAvailable(String userName) {
	        if (userName == null || userName.isBlank()) return false; // ここは好みで
    ...
    public boolean registerUser(String userName, String loginPass, String email) {
        ...
        try {
            ...
            log.warn("Registration failed due to data integrity violation (e.g., duplicate username/email): {}", userName, e);
